...
//    var MaxPage = 100
//    var nextPage:Int = 1
//    var popAnimation = LoadingInPopAnimation()
//    
//    
...
//        
//         popAnimation = LoadingInPopAnimation(frontView: self.tabBarController?.view)
...
//        self.tableView.registerNib(UINib(nibName: "TopicDetailTableViewCells", bundle: nil), forCellReuseIdentifier: REUSE__IDENTIFIER_FOR_TOPICLIST_CELL)
//        if  Reachability.isConnectedToNetwork(){
////             setUpAnimation()
//            
////            popAnimation.setUpAnimation()
...
//            
//            
////            self.popAnimation.animationPop()
//          
//            print(realm.path)
//                        self.articles = realm.objects(Topics)
...
//        print(indexPath.row)
////        self.performSegueWithIdentifier(SEGUE_FROM_TOPTEN_TO_TOPICDETAIL, sender: nil)
//        
//    }
//    
//    // MARK: - Navigation
