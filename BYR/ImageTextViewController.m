...
- (void)addTextAttributedLabel1
{
    ...
    NSURL *url = [ NSURL URLWithString:@"http://bbs.byr.cn/open/attachment/Photo/253920/1216?oauth_token=ddd06f3d6675fa948970dfe763e47f30"];
    
    imageUrlStorage.image = [UIImage imageWithData:[NSData dataWithContentsOfURL:url]];
